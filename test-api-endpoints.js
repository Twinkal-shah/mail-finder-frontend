...
// Configuration
const BASE_URL = process.env.NEXT_PUBLIC_LOCAL_URL || 'http://localhost:3000';
const BACKEND_URL = process.env.NEXT_PUBLIC_LOCAL_URL || 'http://localhost:8000';
...
async function runAllTests() {
  ...
  console.log('   ✅ Email: findEmail, verifyBulkEmail, verifyEmail');
